...
module.exports = function (vips) {
  ...
  Image.newFromFile = function (vipsFilename, options) {
    ...
    var filename = libvips.vips_filename_get_filename(vipsFilename);
    var stringOptions = libvips.vips_filename_get_options(vipsFilename);
  ...
  Image.prototype.writeToBuffer = function (formatString, options) {
    ...
    var stringOptions = libvips.vips_filename_get_options(formatString);
